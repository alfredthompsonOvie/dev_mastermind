...
const schema = z
	.object({
		...
		password: z.string().min(1, { message: "Password must contain at least one character"}),
	})
	.required();
...
export default function Page() {
	...
	return (
		<main className="flex justify-center items-center">
			<section className="max-w-[350px] w-full mx-[auto] rounded bg-secondary p-[2em] text-text">
				<p className="text-center text-4xl font-bold">Login</p>
				<form className="mt-8" onSubmit={handleSubmit(onSubmit)}>
					<section className="mt-2 text-sm leading-tight">
					...
					<section className="flex justify-end text-sm leading-4 my-4">
						<Link href="#" className="hover:underline text-sm text-primary">
							Forgot Password?
						</Link>
					</section>
				...
				{/* <section className="flex items-center pt-4">
					<section className="bg-secondaryAlt h-[1px]"></section>
					<p className="w-full text-sm leading-5 text-center">Login with social accounts</p>
					<section className="bg-red-500 h-[1px]"></section>
				</section>
